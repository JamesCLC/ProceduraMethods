...
////////////////////////////////////////////////////////////////////////////////
#include "cactusshaderclass.h"


CactusShaderClass::CactusShaderClass()
{
	m_vertexShader = 0;
	m_pixelShader = 0;
	m_layout = 0;
...
CactusShaderClass::CactusShaderClass(const CactusShaderClass& other)
{
}
...
bool CactusShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;
...
void CactusShaderClass::Shutdown()
{
...
bool CactusShaderClass::Render(ID3D11DeviceContext* deviceContext, int vertexCount, int instanceCount,
...
bool CactusShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
void CactusShaderClass::ShutdownShader()
{
...
void CactusShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	char* compileErrors;
...
bool CactusShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
...
void CactusShaderClass::RenderShader(ID3D11DeviceContext* deviceContext, int vertexCount, int indexCount)
{
	...
	// Render the models.
	deviceContext->DrawInstanced(vertexCount, indexCount, 0, 0);
