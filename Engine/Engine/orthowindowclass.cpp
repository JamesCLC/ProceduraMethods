...
bool OrthoWindowClass::Initialize(ID3D11Device* device, int windowWidth, int windowHeight, int bitmapWidth, int bitmapHeight)
{
	bool result;
...
bool OrthoWindowClass::Render(ID3D11DeviceContext* deviceContext, int positionX, int positionY)
{
	bool result;
...
bool OrthoWindowClass::UpdateBuffers(ID3D11DeviceContext* deviceContext, int positionX, int positionY)
{
	float left, right, top, bottom;
	VertexType* vertices;
...
void OrthoWindowClass::RenderBuffers(ID3D11DeviceContext* device)
{
	unsigned int stride;
	unsigned int offset;
